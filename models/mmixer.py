...
class MultimodalMixer(nn.Module):
    def __init__(self, image_config, text_config, multimodal_config, bottleneck_config, clasification_config, dropout=0.):
        super().__init__()
        self.bottleneck = nn.Linear((2 * bottleneck_config.window_size + 1) * bottleneck_config.feature_size, bottleneck_config.hidden_dim)
